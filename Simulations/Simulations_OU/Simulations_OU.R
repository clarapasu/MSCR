...
## function that simulates a trajectory with parameters theta,
## an activity centre located at s, over T time steps of time length t
...
## test of the function to simulate a trajectory
